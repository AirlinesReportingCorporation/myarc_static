...
(function() {
	...
	// get query for login
	$.getJSON( "https://www2.arccorp.com/globalassets/myarc/data.json", function( data ) {
	...
	$(".searchIcon").click(function(){ $("#search form").submit(); });
	...
	if($("#alertBody1").length !== 0 || $(".alertframeLong").length !== 0) { 
			...
			if($("#alertPswd").attr("style") == "display:none;" || $("#alertPswd").attr("style") == "display: none;") {
				 console.log("hidden alert"); 
			}
			else if($(".alertframeLong").length !== 0 && $(".alertframeLong") !== null){
				...
				alertHtml = $(".alertframeLong table").html();
				if(alertHtml !== null){ 
					if(alertHtml.indexOf("check.png") !== -1) { 
						$(".alertBar").css("background", "#b2def4");
					}
				}
			}
			else { 
